...
public class BBSFragmentPrivacy extends BBSFragmentBase implements View.OnClickListener{
	public static String PAGEID = "Privacy"; 

	//constructor
	public BBSFragmentPrivacy() {
		super();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		RelativeLayout view = (RelativeLayout)inflater.inflate(R.layout.fragment_privacy, container, false);
		...
		mContent.loadUrl("file:///android_asset/privacy_policy.html");
