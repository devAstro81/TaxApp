...
public class HeaderListView extends RelativeLayout {
    ...
    private class HeaderListViewOnScrollListener implements AbsListView.OnScrollListener {
        ...
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
            ...
            Log.v("real first visible item", "realFirstVisibleItem: " + realFirstVisibleItem);
            ...
            if (scrollingStart) {
                ...
                if (doneMeasuring && headerH != mHeader.getLayoutParams().height) {
                    ...
                    p.topMargin = headerH - (direction < 0 ? next.getHeight(): previous.getHeight());
            ...
            if (noHeaderUpToHeader) {
                ...
                int hPos = mHeader.getLayoutParams().height - (mListView.getChildAt(0).getHeight() + mListView.getChildAt(0).getTop()); 
                mHeader.scrollTo(0, hPos);
            }
        ...
        int mPreviousHeaderSection = -1; 
        int mPreviousHeaderHeight = -1;
        private void addSectionHeader(int actualSection) {
        	if(mPreviousHeaderSection == actualSection){
        		View previousHeader = mHeader.getChildAt(0);
        		if(previousHeader != null) {
        			mHeader.getLayoutParams().height = mPreviousHeaderHeight;
                    previousHeader.scrollTo(0, 0);
                    ((RelativeLayout.LayoutParams)previousHeader.getLayoutParams()).topMargin = 0;
            ...
            if (mAdapter.hasSectionHeaderView(actualSection)) {
                ...
                mPreviousHeaderHeight = header.getMeasuredHeight();
                mPreviousHeaderSection = actualSection;
            } else {
        ...
        private int getRealFirstVisibleItem(int firstVisibleItem, int visibleItemCount) {
            ...
            int mHeaderOffset = mHeader.getHeight(); ///Math.max(0, mHeader.getHeight() - mHeader.getScrollY());
            for (relativeIndex = 0; relativeIndex < visibleItemCount && totalHeight < (mHeaderOffset); relativeIndex++) {
    ...
    public int getScrollRange() {
    	if(mListView != null)
    		return mListView.computeVerticalScrollRange();
    	return 0;
    }
